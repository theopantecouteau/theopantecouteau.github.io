    ...
    ***************************************************************************** */
    ...
    var NgParticlesComponent = /** @class */ (function () {
        function NgParticlesComponent() {
            ...
            this.particlesInit = new core.EventEmitter();
        }
        NgParticlesComponent.prototype.ngAfterViewInit = function () {
            var _this = this;
            this.particlesInit.emit(tsparticles.tsParticles);
            var cb = function (container) {
                _this.particlesLoaded.emit(container);
            };
            if (this.url) {
                tsparticles.tsParticles.loadJSON(this.id, this.url).then(cb);
            }
            else if (this.options) {
                tsparticles.tsParticles.load(this.id, this.options).then(cb);
            }
            else {
    ...
    NgParticlesComponent.propDecorators = {
        ...
        particlesInit: [{ type: core.Output }]
    };
    var ParticlesComponent = /** @class */ (function (_super) {
        __extends(ParticlesComponent, _super);
        function ParticlesComponent() {
            var _this = _super.apply(this, __spreadArray([], __read(arguments))) || this;
            _this.particlesLoaded = new core.EventEmitter();
            _this.particlesInit = new core.EventEmitter();
            return _this;
        }
